<template>
  <view class="content">
    ...
    <view class="section">
      <view class="notice">
        <uni-icons type="sound-filled" size="25">

        </uni-icons>
        <view>{{notice}}</view>
      </view>
      <view style="background-color: white; margin: 15px 0; border-radius: 10px;">
        <uni-row>
          <uni-col :span="6">
          ...
          <uni-col :span="6">
            <view class="grid-item-box">
              <image mode="widthFix" style="width: 50%;" src="../../static/imgs/鱼肉.png"></image>
        ...
        <uni-row :gutter='10'>
          <uni-col :span='12' v-for="item in goodsList" :key="item.name">
            <view style="margin-bottom: 5px; background-color: white; padding: 10px; border-radius: 10px;">
              ...
              <view style="text-align: right;"><uni-icons type="plus" size="25" style="color: #666;"
                  @click="addCart(item)"></uni-icons></view>
            </view>
          </uni-col>
        </uni-row>
      </view>
